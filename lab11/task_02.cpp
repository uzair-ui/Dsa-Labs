...
//        else {
//
//            // if Leaf Node have  no children
//            if (temp->left == NULL && temp->right == NULL) {
//                delete temp;
//                return NULL;
//            }
//
//            // if node has One child (right only)
...
//            }
//
//            // if node has  One child (left only)
...
//            }
//
//            // if node have multiple  children
//            else {
